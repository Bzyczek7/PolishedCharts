# TradingAlert Development Guidelines
...
## Recent Changes
- 003-advanced-indicators: Added Python 3.11+ (backend), TypeScript 5.9+ (frontend) + FastAPI 0.104+, SQLAlchemy 2.0+, pandas 2.1+, numpy 1.26+, lightweight-charts 5.1+, React 19

- 001-initial-setup: Added Python 3.11+ (backend), TypeScript 5.9+ (frontend)
